...
const documents: Documents = {
    ...
    "\n  fragment BlogCategoryMenu_CategoryFragment on Category {\n    id\n    slug\n    name\n    count\n  }\n": types.BlogCategoryMenu_CategoryFragmentFragmentDoc,
    "\n  fragment BlogAuthorCard_AuthorFragment on User {\n    id\n    slug\n    name\n    firstName\n    lastName\n    description\n    avatar(size: 160) {\n      url\n    }\n  }\n": types.BlogAuthorCard_AuthorFragmentFragmentDoc,
    "\n  fragment TaxonomyChip_TermFragment on TermNode {\n    id\n    name\n    slug\n  }\n": types.TaxonomyChip_TermFragmentFragmentDoc,
    "\n  fragment BlogAuthorPage_onQuery on RootQuery {\n    blogAuthor: users(first: 1, where: { nicename: $slug }) {\n      nodes {\n        ...BlogAuthorCard_AuthorFragment\n      }\n    }\n    authorPosts: posts(\n      first: $first\n      after: $after\n      where: {\n        orderby: { field: DATE, order: DESC }\n        authorName: $slug\n        language: $language\n      }\n    ) {\n      nodes {\n        ...BlogPostCard_PostFragment\n      }\n      pageInfo {\n        hasNextPage\n        endCursor\n      }\n    }\n  }\n": types.BlogAuthorPage_OnQueryFragmentDoc,
    "\n  query BlogAuthorPage(\n    $slug: String!\n    $language: LanguageCodeFilterEnum = PT\n    $first: Int = 11\n    $after: String\n  ) {\n    ...BlogAuthorPage_onQuery\n  }\n": types.BlogAuthorPageDocument,
    "\n  query BlogAuthorSlugs(\n    $first: Int = 100\n    $after: String\n  ) {\n    users(first: $first, after: $after, where: { hasPublishedPosts: [POST] }) {\n      nodes {\n        slug\n      }\n      pageInfo {\n        hasNextPage\n        endCursor\n      }\n    }\n  }\n": types.BlogAuthorSlugsDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  fragment BlogCategoryMenu_CategoryFragment on Category {\n    id\n    slug\n    name\n    count\n  }\n"): typeof import('./graphql').BlogCategoryMenu_CategoryFragmentFragmentDoc;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  fragment BlogAuthorCard_AuthorFragment on User {\n    id\n    slug\n    name\n    firstName\n    lastName\n    description\n    avatar(size: 160) {\n      url\n    }\n  }\n"): typeof import('./graphql').BlogAuthorCard_AuthorFragmentFragmentDoc;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  fragment BlogAuthorPage_onQuery on RootQuery {\n    blogAuthor: users(first: 1, where: { nicename: $slug }) {\n      nodes {\n        ...BlogAuthorCard_AuthorFragment\n      }\n    }\n    authorPosts: posts(\n      first: $first\n      after: $after\n      where: {\n        orderby: { field: DATE, order: DESC }\n        authorName: $slug\n        language: $language\n      }\n    ) {\n      nodes {\n        ...BlogPostCard_PostFragment\n      }\n      pageInfo {\n        hasNextPage\n        endCursor\n      }\n    }\n  }\n"): typeof import('./graphql').BlogAuthorPage_OnQueryFragmentDoc;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query BlogAuthorPage(\n    $slug: String!\n    $language: LanguageCodeFilterEnum = PT\n    $first: Int = 11\n    $after: String\n  ) {\n    ...BlogAuthorPage_onQuery\n  }\n"): typeof import('./graphql').BlogAuthorPageDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  query BlogAuthorSlugs(\n    $first: Int = 100\n    $after: String\n  ) {\n    users(first: $first, after: $after, where: { hasPublishedPosts: [POST] }) {\n      nodes {\n        slug\n      }\n      pageInfo {\n        hasNextPage\n        endCursor\n      }\n    }\n  }\n"): typeof import('./graphql').BlogAuthorSlugsDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
