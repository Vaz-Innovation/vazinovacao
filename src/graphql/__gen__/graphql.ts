...
type TaxonomyChip_TermFragment_Tag_Fragment = { __typename?: 'Tag', id: string, name?: string | null, slug?: string | null } & { ' $fragmentName'?: 'TaxonomyChip_TermFragment_Tag_Fragment' };
...
export type BlogList_OnQueryFragment = { __typename?: 'RootQuery', categories?: { __typename?: 'RootQueryToCategoryConnection', nodes: Array<(
      ...
      { __typename?: 'Post' }
      & { ' $fragmentRefs'?: { 'BlogPostCard_PostFragmentFragment': BlogPostCard_PostFragmentFragment } }
    )>, pageInfo: { __typename?: 'RootQueryToPostConnectionPageInfo', hasNextPage: boolean, endCursor?: string | null } } | null } & { ' $fragmentName'?: 'BlogList_OnQueryFragment' };

export type BlogListPageQueryVariables = Exact<{
  language?: InputMaybe<LanguageCodeFilterEnum>;
  first?: InputMaybe<Scalars['Int']['input']>;
  after?: InputMaybe<Scalars['String']['input']>;
}>;
...
export type BlogListPageQuery = (
  { __typename?: 'RootQuery' }
  & { ' $fragmentRefs'?: { 'BlogList_OnQueryFragment': BlogList_OnQueryFragment } }
);

export type BlogListPageInfoQueryVariables = Exact<{
  language?: InputMaybe<LanguageCodeFilterEnum>;
  first?: InputMaybe<Scalars['Int']['input']>;
  after?: InputMaybe<Scalars['String']['input']>;
}>;
...
export type BlogPost_OnQueryFragment = { __typename?: 'RootQuery', post?: (
    ...
    & { ' $fragmentRefs'?: { 'BlogPostHeader_PostFragmentFragment': BlogPostHeader_PostFragmentFragment } }
  ) | null, relatedPosts?: { __typename?: 'RootQueryToPostConnection', nodes: Array<(
      { __typename?: 'Post' }
      & { ' $fragmentRefs'?: { 'BlogPostCard_PostFragmentFragment': BlogPostCard_PostFragmentFragment } }
    )> } | null } & { ' $fragmentName'?: 'BlogPost_OnQueryFragment' };
...
export type BlogPostPageQuery = (
  { __typename?: 'RootQuery' }
  & { ' $fragmentRefs'?: { 'BlogPost_OnQueryFragment': BlogPost_OnQueryFragment } }
);
...
export const TaxonomyChip_TermFragmentFragmentDoc = new TypedDocumentString(`
  ...
  slug
    ...
    `, {"fragmentName":"TaxonomyChip_TermFragment"}) as unknown as TypedDocumentString<TaxonomyChip_TermFragmentFragment, unknown>;
export const BlogPostCard_PostFragmentFragmentDoc = new TypedDocumentString(`
...
fragment TaxonomyChip_TermFragment on TermNode {
  ...
  name
  slug
}`, {"fragmentName":"BlogList_onQuery"}) as unknown as TypedDocumentString<BlogList_OnQueryFragment, unknown>;
export const BlogPostHeader_PostFragmentFragmentDoc = new TypedDocumentString(`
  ...
  name
  slug
}`, {"fragmentName":"BlogPostHeader_PostFragment"}) as unknown as TypedDocumentString<BlogPostHeader_PostFragmentFragment, unknown>;
export const BlogPost_OnQueryFragmentDoc = new TypedDocumentString(`
...
}`) as unknown as TypedDocumentString<BlogListPageQuery, BlogListPageQueryVariables>;
export const BlogListPageInfoDocument = new TypedDocumentString(`
    query BlogListPageInfo($language: LanguageCodeFilterEnum = PT, $first: Int = 11, $after: String) {
  posts(
    first: $first
    after: $after
    where: {orderby: {field: DATE, order: DESC}, language: $language}
    ...
    `) as unknown as TypedDocumentString<BlogListPageInfoQuery, BlogListPageInfoQueryVariables>;
export const BlogPostPageDocument = new TypedDocumentString(`
    query BlogPostPage($slug: ID!, $language: LanguageCodeFilterEnum = PT) {
  ...BlogPost_onQuery
}
    fragment BlogPostCard_PostFragment on Post {
  id
...
}`) as unknown as TypedDocumentString<BlogPostPageQuery, BlogPostPageQueryVariables>;
export const BlogPostSlugsDocument = new TypedDocumentString(`
    query BlogPostSlugs($language: LanguageCodeFilterEnum = PT, $first: Int = 100, $after: String) {
  posts(
    first: $first
    after: $after
    where: {orderby: {field: DATE, order: DESC}, language: $language}
